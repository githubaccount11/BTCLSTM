# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 16:08:50 2020

@author: Leigh Fair-Smiley and sentDex
"""
...
NAME = f"{RATIO_TO_PREDICT}-{SEQ_LEN}-SEQ-{FUTURE_PERIOD_PREDICT}-PRED-200x5-Batch-1-Epoch-1-BSize-16{int(time.time())}"
...
for ratio in ratios:  # begin iteration
    ...
    print(ratio)
    dataset = f'BTCData/BTC.csv'  # get the full path to the file.
...
model = Sequential()
model.add(LSTM(200, input_shape=(train_x.shape[1:]), return_sequences=True))
